...
# USAGE: FIRST adapt the sed-line here and copy the Vorlage to your current-working-dir, and then call this with the NAME of your new xml file, shich will be generated by the sed-line here:
fp1=${1:?"usage1: ... <new-xml-file to be generated here by sed-replacements>"}
out1="${fp1}.noxml.pdf"
out2="${fp1}.pdf"
...
sed  -e 's@__1stdzahl__@168@g'   -e 's@__1stddatumbis__@20250901@g'    -e 's@__1stddatumvom__@20250801@g'   -e 's@__1rechdatum__@20250904@g'    -e 's@__1rechnr__@2025-08-DoPro@g'  -e 's@__1netto__@11424@g'    -e 's@__1ust__@2170.56@g' -e 's@__1brutto__@13594.56@g'  RechVorlage1-DoPrj-vwfs.xml  >|   "$fp1"
