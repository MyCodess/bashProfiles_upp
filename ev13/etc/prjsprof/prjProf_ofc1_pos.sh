...
alias te1_pcck1=te1_prjcode2 ; alias  cdpcck1='cdlla   ${q_prjcodeck1DP}' ; alias  setpypathcodeck1=setpypathcode2
...
alias te1_pcdjix1=te1_prjcode3 ; alias  cdpcdjix1='cdlla   ${q_prjcodedjix1DP}' ; alias  setpypathcodedjix1=setpypathcode3
...
# _______:  te1_fixs/evvs (non-prjcodeX):
