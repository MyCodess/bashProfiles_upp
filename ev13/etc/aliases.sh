...
alias  wksterms1='xfce4-terminal  --disable-server --geometry  120x62  --default-working-directory=${vaarAuWorksDP}  --tab  --active-tab  --tab  --tab  --tab  --tab  --tab --working-directory=${SW1DocsDP}  --tab --working-directory=${SW1dres1kkDP}  --tab --working-directory=${SW1dntsDP}  &'
...
alias hrma='rm -iv $histfilePrev $HISTFILE $HOME/.*hist*  $HOME/.hs_* ; unset HISTFILE' ##--U-: -v -history-rm-...
