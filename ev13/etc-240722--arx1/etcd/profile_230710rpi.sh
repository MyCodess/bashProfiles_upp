...
export  q_diskTg=sdc32p2             #- OS-short-abbrev-name : used for q_syysTg...; does NOT have to be realy Disk-Part! is just yout TAG !
export  q_syysNoTg=230710            #- MY-assigned-No, just randomly for identifying my system; never changes! usu. the date of very FIRST install YYMM !
